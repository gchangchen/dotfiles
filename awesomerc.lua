...
awful.screen.connect_for_each_screen(function(s)
	...
	--awful.tag({ "main", "terminal"}, s, awful.layout.layouts[1])
	awful.tag.add("main", {
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Up",    function () update_volume("2dB+") end,
              {description = "volume 2dB+", group = "awesome"}),
    ...
    awful.key({ modkey, "Shift"   }, "space", function () awful.util.spawn("xset s off -dpms") end,
              {description = "screensaver off", group = "awesome"}),
...
awful.rules.rules = {
	...
	{ rule = { class = "Chromium" }, properties = { tag = "main", switchtotag = true, titlebars_enabled = false } },
	{ rule = { class = "Thunar" }, properties = { tag = "main", switchtotag = true, } },
	{ rule = { class = "Termite" }, properties = { tag = "terminal", switchtotag = true, titlebars_enabled = false } },
}
-- }}}
